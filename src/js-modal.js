...
export default (function() {
   ...
   */
  function createModalContainer(options=defaultOptions) {
      var container = document.createElement('div');
      var classes = options.containerClasses;
      classes.forEach(function(addingClass) { container.classList.add(addingClass) });
      return container;
  }
  ...
  function createModalCloseButton(options=defaultOptions) {
      ...
      closeBtn.classList.add(options.closeClass);
  ...
  function drag() {
      ...
      var LEFT_REMAIN = 30, TOP_REMAIN = 30;
      ...
      var initialShiftLeft = 0, initialShiftTop = 0;
